...
const TOKEN = "ghs_examplereferencetokenvalue0123456789"; // gitleaks:allow -- fake credential fixture for the redaction tests
...
test("a credential is only ever attached to a remote its allowlist names", () => {
  ...
  for (const other of ["crytic/properties", "monad-developers/ultrafuzz", "OWASP/owasp-scs"]) {
