...
`
  ...
  it("requires explicit destinations for valid-empty output declarations", () => {
    ...
    for (const prompt of [
      ...
      "Write confirmed defects to {{output_findings_path}}.",
      "Record every security flaw in {{output_findings_path}}.",
      "File confirmed vulnerabilities at {{output_findings_path}}.",
      "Send all findings to {{output_findings_path}}.",
  ...
  it("rejects placeholder empties and instructions that bind the destination to different content", () => {
    for (const prompt of [
      ...
      "Write findings to {{output_findings_path}}. Instead, do not create it.",
      "Write findings to {{output_findings_path}}. Actually, never create the file.",
      "Write findings to {{output_findings_path}}. Cancel that instruction.",
      "Write findings to {{output_findings_path}} or stdout.",
      "Either write findings to {{output_findings_path}} or stdout.",
      "Write findings to {{output_findings_path}} (or skip it).",
  ...
  it("rejects conditional, descriptive, historical, quoted, code, comment, and example contexts", () => {
    for (const prompt of [
      ...
      "## Optional output\n\nWrite findings to {{output_findings_path}}.",
      "Optional\n\nReview the output requirements below.\nWrite findings to {{output_findings_path}}.",
      "Optional output\n\nReview the output requirements below.\nWrite findings to {{output_findings_path}}.",
      "Example\n\nReview the output requirements below.\nWrite findings to {{output_findings_path}}.",
      "If findings exist\n\nReview the output requirements below.\nWrite findings to {{output_findings_path}}.",
      "## Optional\n### Final output\nWrite findings to {{output_findings_path}}.",
      ...
      '"Write findings to" {{output_findings_path}}.',
      "![Write findings to {{output_findings_path}}.](example.svg)",
      "<code>Write findings to {{output_findings_path}}.</code>",
      "<template>Write findings to {{output_findings_path}}.</template>",
      "<blockquote>Write findings to {{output_findings_path}}.</blockquote>",
      '<img alt="Write findings to {{output_findings_path}}." src="example.svg">',
      ...
      "If findings exist, write them to {{output_findings_path}}. Otherwise do not write an empty findings array there.",
      "If findings exist, write them to {{output_findings_path}}. Otherwise never write an empty findings array there.",
      "If findings exist, write them to {{output_findings_path}}. Otherwise write an empty findings array there. This fallback is optional.",
      "If findings exist, write them to {{output_findings_path}}. Otherwise write an empty findings array there. You may omit this fallback.",
