...
export const ARTIFACT_VALIDATOR_SMOKE_FIXTURE_SHA256 =
  "37517e5f3dc66819f61f5a7bb8ace1921282415f10551d2defa5c3eb0985b570" as const;
...
export function readRegularFileSnapshot(filePath: string, maxBytes: number): Buffer {
  ...
  try {
    ...
    if (
      ...
      // routinely complete inside a single tick on an NVMe disk, and the
      // replacement then goes undetected. The unlink that rename performs drops
