---
id: property-specification-crytic
display_name: Property Specification (Crytic)
---
...
Write the JSON catalog first to {{artifact_path}}/properties/crytic.json, then
write its matching Markdown companion to {{artifact_path}}/properties/crytic.md.
