...
| Resolved config                       | `ultrafuzz.config.v2` resolved JSON                                 | `ultrafuzz.resolved-config.v4`; retry policy is required in the closed persisted shape. Project TOML remains `ultrafuzz.config.v2`. |
