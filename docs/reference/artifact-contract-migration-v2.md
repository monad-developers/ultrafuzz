...
| Run plan                              | `ultrafuzz.run-plan.v2`                                               | `ultrafuzz.run-plan.v3`; production roots and sealed data-governance/reviewer authority are required.                                   |
...
| Resolved config                       | `ultrafuzz.resolved-config.v3`                                      | `ultrafuzz.resolved-config.v4`; resource budgets are required in the closed persisted shape. Project TOML remains `ultrafuzz.config.v2`. |
