...
| `exhaustive` | Highest-cost release or critical-system investigations. | Project topology | `strategy_loops=5`; `dynamic_strategies_enumerator=unlimited`; `same_agent_attempts=5`; `max_parallel_agents=8`; `max_parallel_nodes=16`; `workflow_deadline_seconds=86400` |
