...
- Tightens prompt-owned report contracts so strategy detection rows are canonically renderable, every finding uses the High/Medium/Low severity vocabulary, and unknown campaign backends are omitted instead of emitted as unavailable (#394, #395, #396).
