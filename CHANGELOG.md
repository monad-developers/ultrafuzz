...
- New public benchmark sandboxes now expire after six hours, bounding the cost of a concurrency-cancelled orphan, while private workers, recovery workers, and public runs resumed from existing 24-hour launch state retain their recorded lifetime (#422; related to #371).
