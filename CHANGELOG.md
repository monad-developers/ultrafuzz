...
- Current final-report producers now replace model-authored property implementation coverage with one canonical projection derived from the verified property catalog, `implemented-properties@2` handoff, and resolved priority configuration; the live producer, runtime gate, and CLI reconciler share the same fail-closed derivation (#461).
