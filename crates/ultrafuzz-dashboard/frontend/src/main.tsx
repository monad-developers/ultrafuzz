    ...
    <div className="toolbar">
      <div className="toolbar__main" aria-label="Run controls">
        ...
        <div className="toolbar__controls">
          ...
          <CommandButton disabled={!can('restart')} onClick={() => runCommand('restart')} variant="secondary">
            Restart
          </CommandButton>
          <details className="advanced-actions">
            ...
            <div className="advanced-actions__panel">
              ...
              <ActionGroup label="Run inspection">
                <CommandButton disabled={!can('status')} onClick={() => runCommand('status')} variant="ghost">
                  Status
                </CommandButton>
                <CommandButton disabled={!can('list')} onClick={() => runCommand('list')} variant="ghost">
                  Runs
                </CommandButton>
              ...
              <ActionGroup label="Diagnostics and config">
                <CommandButton disabled={!can('doctor')} onClick={() => runCommand('doctor')} variant="secondary">
                  Doctor
                </CommandButton>
    ...
    <div className="panel-content">
      ...
      <div className="panel-stack">
        ...
        <section className="panel-section">
          <h3>Config Markdown</h3>
          <textarea
            aria-label="Config Markdown"
...
function collapseStrategyNodes(
  ...
  if (loopedByLogicalId.size) {
    ...
    const nextNodes = [...visibleNodes, ...logicalNodes].map(
      (node): DashboardFlowNode => ({
        ...node,
        data: {
          ...node.data,
